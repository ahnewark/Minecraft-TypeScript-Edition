...
export default class Random {
    ...
    nextDouble() {
        ...
        console.log(_next.toNumber());
        return _next.shiftLeft(27).add(this.next(27)).toNumber() * this.doubleUnit;
    }
    ...
    nextInt(max = -1) {
        ...
        let r: number | Long = this.next(31);
        let m = max - 1;
    ...
    _compareAndSet(expect, update: Long) {
