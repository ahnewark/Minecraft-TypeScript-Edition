...
export default class ModelPlayer extends ModelBase {
    ...
    private hasItemInHand: boolean;
    private isSneaking: boolean;

    private width: number;
    private height: number;

    private head: ModelRenderer;
    private body: ModelRenderer;
    private leftArm: ModelRenderer;
    private rightArm: ModelRenderer;
    private rightLeg: ModelRenderer;
    private leftLeg: ModelRenderer;
    ...
    render(stack, limbSwing: number, limbSwingStrength: number, timeAlive: number, yaw, pitch, partialTicks) {
    ...
    setRotationAngles(stack, limbSwing: number, limbSwingStrength: number, timeAlive: number, yaw, pitch, partialTicks) {
        // Head rotation
