...
import { ItemStack } from "../../../../../../new/ItemStack.js";
import ChunkSection from "../../../../../../net/minecraft/client/world/ChunkSection.js";
import { Block } from "../../../../../../new/Block.js";
...
export default class WorldRenderer {
    ...
    private itemToRender: ItemStack;
    ...
    public webRenderer: THREE.WebGLRenderer;
    ...
    async onTick() {
        ...
        let player = this.minecraft.player;
        let itemStack = player.inventory.getCurrentItem();
    ...
    async orientCamera(partialTicks) {
        ...
        // Position
        let x = player.prevPosX + (player.posX - player.prevPosX) * partialTicks;
        let y = player.prevPosY + (player.posY - player.prevPosY) * partialTicks + player.getEyeHeight();
        let z = player.prevPosZ + (player.posZ - player.prevPosZ) * partialTicks;
        ...
        this.setupFog(x, z, false, partialTicks);
    ...
    setupFog(x, z, inWater, partialTicks) {
        if (inWater) {
            ...
            let skyColor = new Vector3(255, 255, 255);
            let fogColor = new Vector3(255, 255, 255);
            let sunsetColor = new Vector3(255, 255, 255);
    ...
    renderHand(partialTicks) {
        ...
        let itemId = firstPerson ? this.itemToRender : player.inventory.getCurrentItem().itemID;
    ...
    async renderBlockHitBox(player, partialTicks) {
        ...
        if ((this.blockHitBox.visible = hitBoxVisible)) {
            ...
            // Get block type
            let world = this.minecraft.world;
            let typeId = await world.getBlockId(x, y, z);
