...
export default class GameWindow {
    ...
    private mouseMotionX: number;
    private mouseMotionY: number;
    private mouseInsideWindow: boolean;
    private mouseDownInterval: number;
    private focusState: FocusStateType;
    private lastIngameSwitchTime: number;
    private mobileDevice: boolean;
    private wrapper: HTMLElement;
    private canvasWorld: HTMLCanvasElement;
    private canvasDebug: HTMLCanvasElement;
    private canvasPlayerList: HTMLCanvasElement;
    private canvasItems: HTMLCanvasElement;
    private canvas: HTMLCanvasElement;
    private scaleFactor: number;
    private pageX: number;
    private pageY: number;

    constructor(minecraft: Minecraft, canvasWrapperId: string) {
    ...
    registerMobileListeners() {
        ...
        let prevTouched: false | Touch = false;
    ...
    openUrl(url, newTab: boolean = false) {
        if (newTab) {
