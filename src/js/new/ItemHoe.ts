...
export  class ItemHoe extends Item {
	...
	public async onItemUse(itemStack1: ItemStack| null, entityPlayer2: EntityPlayer| null, world3: World| null, i4: int, i5: int, i6: int, i7: int):  Promise<boolean> {
		...
		if((material9.isSolid() || i8 !== Block.grass.blockID) && i8 !== Block.dirt.blockID) {
			...
			let  block10: Block = Block.tilledField;
			...
			if(world3.multiplayerWorld) {
				...
				await world3.setBlockWithNotify(i4, i5, i6, block10.blockID);
				...
				if(world3.rand.nextInt(8) === 0 && i8 === Block.grass.blockID) {
					...
					for(let  i12: int = 0; i12 < b11; ++i12) {
						...
						let  entityItem17: EntityItem = new  EntityItem(world3, (i4 as float + f14) as double, (i5 as float + f15) as double, (i6 as float + f16) as double, new  ItemStack(Item.seeds));
						entityItem17.delayBeforeCanPickup = 10;
						await world3.entityJoinedWorld(entityItem17);
					}
				}
