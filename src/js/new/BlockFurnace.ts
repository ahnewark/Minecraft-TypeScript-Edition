...
export  class BlockFurnace extends BlockContainer {
	...
	public idDropped(i1: int, random2: java.util.Random| null):  int {
	...
	private setDefaultDirection(world1: World| null, i2: int, i3: int, i4: int):  void {
		let  i5: int = world1.getBlockId(i2, i3, i4 - 1);
		let  i6: int = world1.getBlockId(i2, i3, i4 + 1);
		let  i7: int = world1.getBlockId(i2 - 1, i3, i4);
		let  i8: int = world1.getBlockId(i2 + 1, i3, i4);
		let  b9: byte = 3;
	...
	public getBlockTexture(iBlockAccess1: IBlockAccess| null, i2: int, i3: int, i4: int, i5: int):  int {
		if(i5 === 1) {
			return this.blockIndexInTexture + 17;
		} else if(i5 === 0) {
			return this.blockIndexInTexture + 17;
		} else {
			let  i6: int = iBlockAccess1.getBlockMetadata(i2, i3, i4);
			return i5 !== i6 ? this.blockIndexInTexture : (this.isActive ? this.blockIndexInTexture + 16 : this.blockIndexInTexture - 1);
		}
	}

	public randomDisplayTick(world1: World| null, i2: int, i3: int, i4: int, random5: java.util.Random| null):  void {
		if(this.isActive) {
			let  i6: int = world1.getBlockMetadata(i2, i3, i4);
	...
	public blockActivated(world1: World| null, i2: int, i3: int, i4: int, entityPlayer5: EntityPlayer| null):  boolean {
		if(world1.multiplayerWorld) {
			return true;
		} else {
			let  tileEntityFurnace6: TileEntityFurnace = world1.getBlockTileEntity(i2, i3, i4) as TileEntityFurnace;
	...
	public static async updateFurnaceBlockState(z0: boolean, world1: World| null, i2: int, i3: int, i4: int):  Promise<void> {
		let  i5: int = world1.getBlockMetadata(i2, i3, i4);
	...
	public onBlockPlacedBy(world1: World| null, i2: int, i3: int, i4: int, entityLiving5: EntityLiving| null):  void {
