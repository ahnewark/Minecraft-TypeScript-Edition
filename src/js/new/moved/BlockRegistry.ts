...
export class BlockRegistry {
	...
	public static readonly pressurePlateStone:  Block = (new  BlockPressurePlate(70, BlockRegistry.stone.blockIndexInTexture, EnumMobType.mobs)).setHardness(0.5).setStepSound(Block.soundStoneFootstep).setBlockName("pressurePlate");
	...
	public static readonly pressurePlatePlanks:  Block = (new  BlockPressurePlate(72, BlockRegistry.planks.blockIndexInTexture, EnumMobType.everything)).setHardness(0.5).setStepSound(Block.soundWoodFootstep).setBlockName("pressurePlate");
	...
	public static readonly button:  Block = (new  BlockButton(77, BlockRegistry.stone.blockIndexInTexture)).setHardness(0.5).setStepSound(Block.soundStoneFootstep).setBlockName("button");
