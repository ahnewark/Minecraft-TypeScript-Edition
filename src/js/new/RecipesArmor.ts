...
export  class RecipesArmor extends JavaObject {
	...
	private recipeItems:  any[][] | null =  [[Item.leather, Block.fire, Item.ingotIron, Item.diamond, Item.ingotGold], [Item.helmetLeather, Item.helmetChain, Item.helmetSteel, Item.helmetDiamond, Item.helmetGold], [Item.plateLeather, Item.plateChain, Item.plateSteel, Item.plateDiamond, Item.plateGold], [Item.legsLeather, Item.legsChain, Item.legsSteel, Item.legsDiamond, Item.legsGold], [Item.bootsLeather, Item.bootsChain, Item.bootsSteel, Item.bootsDiamond, Item.bootsGold]];
