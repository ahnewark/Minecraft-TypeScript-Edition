...
export  class EntityEgg extends Entity {
	...
	private field_20051_g:  EntityLiving | null;
	...
	public async onUpdate():  Promise<void> {
		...
		if(movingObjectPosition3 !== null) {
			if(movingObjectPosition3.entityHit !== null && await movingObjectPosition3.entityHit.attackEntityFrom(this.field_20051_g, 0)) {
				;
			}
