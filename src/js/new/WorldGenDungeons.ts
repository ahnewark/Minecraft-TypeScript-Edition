...
export  class WorldGenDungeons extends WorldGenerator {
	public async generate(world1: World| null, random2: Random| null, i3: int, i4: int, i5: int):  Promise<boolean> {
		...
		if(i9 >= 1 && i9 <= 5) {
					...
					for(i12 = i5 - i8 - 1; i12 <= i5 + i8 + 1; ++i12) {
						if(i10 !== i3 - i7 - 1 && i11 !== i4 - 1 && i12 !== i5 - i8 - 1 && i10 !== i3 + i7 + 1 && i11 !== i4 + b6 + 1 && i12 !== i5 + i8 + 1) {
							...
							if(i11 === i4 - 1 && random2.nextInt(4) !== 0) {
								await world1.setBlockWithNotify(i10, i11, i12, BlockRegistry.cobblestoneMossy.blockID);
							} else {
								await world1.setBlockWithNotify(i10, i11, i12, BlockRegistry.cobblestone.blockID);
							}
						}
					}
				}
			...
			for(i10 = 0; i10 < 2; ++i10) {
				for(i11 = 0; i11 < 3; ++i11) {
					...
					if(world1.isAirBlock(i12, i4, i14)) {
						...
						if(i15 === 1) {
							await world1.setBlockWithNotify(i12, i4, i14, BlockRegistry.crate.blockID);
			...
			await world1.setBlockWithNotify(i3, i4, i5, BlockRegistry.mobSpawner.blockID);
	...
	private pickCheckLootItem(random1: Random| null):  ItemStack | null {
		...
		return i2 === 0 ? new  ItemStack(ItemRegistry.saddle) : (i2 === 1 ? new  ItemStack(ItemRegistry.ingotIron, random1.nextInt(4) + 1) : (i2 === 2 ? new  ItemStack(ItemRegistry.bread) : (i2 === 3 ? new  ItemStack(ItemRegistry.wheat, random1.nextInt(4) + 1) : (i2 === 4 ? new  ItemStack(ItemRegistry.gunpowder, random1.nextInt(4) + 1) : (i2 === 5 ? new  ItemStack(ItemRegistry.silk, random1.nextInt(4) + 1) : (i2 === 6 ? new  ItemStack(ItemRegistry.bucketEmpty) : (i2 === 7 && random1.nextInt(100) === 0 ? new  ItemStack(ItemRegistry.appleGold) : (i2 === 8 && random1.nextInt(2) === 0 ? new  ItemStack(ItemRegistry.redstone, random1.nextInt(4) + 1) : (i2 === 9 && random1.nextInt(10) === 0 ? new  ItemStack(Item.itemsList[ItemRegistry.record13.shiftedIndex + random1.nextInt(2)]) : null)))))))));
	}
